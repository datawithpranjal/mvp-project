export const LAUNCH_READY_CODING_LAB_SLUGS = [
  ...
  "python-foundry-09-latest-customer-updates",
  "python-foundry-10-reconcile-snapshot-keys",
  "python-foundry-11-sessionize-clickstream-events",
  "python-foundry-12-detect-delayed-jobs",
  "python-foundry-13-build-retry-summary",
  "python-foundry-14-aggregate-daily-net-revenue",
  "python-foundry-15-find-missing-partitions",
  "python-foundry-16-normalize-schema-drift-records",
  "python-foundry-17-build-compaction-plan",
  "python-foundry-18-top-customers-with-ties",
  "python-foundry-19-apply-cdc-events",
  "python-foundry-20-build-dependency-run-order",
  "python-foundry-21-rolling-error-rate",
  "python-foundry-22-deduplicate-exactly-once-events",
  "python-foundry-23-prepare-scd2-changes",
  "python-foundry-24-detect-metric-drift",
  "python-foundry-25-allocate-backfill-windows",
